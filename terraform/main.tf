...
resource "aws_vpc" "main" {
  ...
  tags = {
    ...
    Name = "agentbridge-intervention-scheduler-to-boost-mastery"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-intervention-scheduler-to-boost-mastery-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-intervention-scheduler-to-boost-mastery"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-intervention-scheduler-to-boost-mastery-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-intervention-scheduler-to-boost-mastery-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-intervention-scheduler-to-boost-mastery-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-intervention-scheduler-to-boost-mastery-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-intervention-scheduler-to-boost-mastery-flow"
